...
ggplot(sim, aes(x = Distance, color = Sem, fill = Sem))+
...
my_priors <- c(prior(normal(107, 40),
                    class = 'Intercept'),
               prior(normal(0,40),
                     class = 'b'))
...
#I tried to figure how to set the path but I couldn't figure it out...then I tried to download cmdstan and rtools and I ultimately got stuck with command prompts and so this is how far I got in the homework, I'll have to figure the rest out in class, because it's 10.20 pm and I need to go to sleep.
